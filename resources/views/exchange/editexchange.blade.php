    ...
    <div class="content-page">
        ...
        <!-- Page title -->
            <ul class="list-inline menu-left mb-0">
                ...
                <li class="hide-phone list-inline-item app-search"><h3 class="page-title">Edit Exchanger</h3></li>
            </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card m-b-20">
                            ...
                            <div class="card-body"><h4 class="mt-0 header-title">Edit Exchanger</h4>

                                <p class="text-muted m-b-30 font-14">Edit Exchanger Details from here </p>

                                <form class="" action="{{route('exchange.update',$edit->id)}}" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" required placeholder="Customer Name" id="quantity" name="name" value="{{$edit->exchanger}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group text-center">
                                        ...
                                        <div><button type="submit" class="btn btn-outline-indigo waves-effect waves-light m-r-5">Save</button>
                                            <button type="reset" class="btn btn-outline-indigo waves-effect">Cancel</button>
                                        </div>
                                    </div>
