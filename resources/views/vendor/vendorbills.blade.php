...
<!-- Mirrored from themesbrand.com/admiria/layouts/vertical/ecommerce-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Dec 2018 02:55:53 GMT -->
    ...
    <div class="content-page">
        ...
        <!-- Page title -->
            <ul class="list-inline menu-left mb-0">
                ...
                <li class="hide-phone list-inline-item app-search"><h3 class="page-title">Vendor Bills</h3></li>
            </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="mt-0 header-title">Vendor Bills</h4>

                                <p class="text-muted m-b-30 font-14">See Vendor Bill from here.</p>
                                <table id="datatable" class="table table-striped table-bordered ">
                                    ...
                                    @foreach ($bills as $bill)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$bill->pakha_kaldar}} ({{$bill->todaykaldar}}) kal</td>
