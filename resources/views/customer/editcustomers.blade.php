    ...
    <div class="content-page">
        ...
        <!-- Page title -->
            <ul class="list-inline menu-left mb-0">
                ...
                <li class="hide-phone list-inline-item app-search"><h3 class="page-title">Edit Customer</h3></li>
            </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card m-b-20">
                            ...
                            <div class="card-body"><h4 class="mt-0 header-title">Edit Customer</h4>

                                <p class="text-muted m-b-30 font-14">Edit Customers Details from here </p>

                                <form class="" action="{{route('customer.update',$edit->id)}}" enctype="multipart/form-data" method="post">
