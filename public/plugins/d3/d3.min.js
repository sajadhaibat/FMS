!function () {
        ...
        function t(n, t, u, i, o) {
            return function () {
                ...
                var l, s = this, f = ta.event.target, h = s.parentNode, g = e.of(s, arguments), p = 0, v = n(),
                    d = ".drag" + (null == v ? "" : "-" + v), m = ta.select(u()).on(i + d, a).on(o + d, c), y = $(),
                    M = t(h, v);
                r ? (l = r.apply(s, arguments), l = [l.x - M[0], l.y - M[1]]) : l = [0, 0], g({type: "dragstart"})
            }
        }

        var e = w(n, "drag", "dragstart", "dragend"), r = null, u = t(y, ta.mouse, G, "mousemove", "mouseup"),
    ...
    var Sc, kc, Ec, Ac, Nc, Cc, zc, qc, Lc, Tc, Rc, Dc = {
        sphere: y, point: we, lineStart: ke, lineEnd: Ee, polygonStart: function () {
            Dc.lineStart = Ae
        }, polygonEnd: function () {
            Dc.lineStart = ke
        }
    ...
    ta.geo.path = function () {
        ...
        function n() {
            var n = "function" == typeof r ? r.apply(this, arguments) : r, t = sr(-n[0] * Fa, -n[1] * Fa, 0).invert,
                u = [];
    ...
    var $c, Bc = {sphere: y, point: y, lineStart: br, lineEnd: y, polygonStart: y, polygonEnd: y},
        Wc = _r(function (n) {
    ...
    ta.layout.histogram = function () {
        ...
        var o, a = ta.layout.hierarchy(), c = Math.round, l = [1, 1], s = null, f = Di, h = !1, g = "squarify",
            p = .5 * (1 + Math.sqrt(5));
    ...
    ta.scale.quantile = function () {
        ...
        function n() {
            ...
            if ((p = Math.min(Math.abs(l - n) / 2, +u.apply(this, arguments))) > .001) {
                ...
                if (null != S) {
                    var I = Math.min(p, (n - F) / (j - 1)), Z = ho([y, M], [S, k], n, -I, g),
        ...
        function n(n) {
            n.each(function () {
                var n, l = ta.select(this), s = this.__chart__ || e, f = this.__chart__ = e.copy(),
                    ...
                    m = ta.transition(p.order()).style("opacity", 1), y = Math.max(u, 0) + o, M = ji(f),
    ...
    ta.svg.brush = function () {
        ...
        function u() {
            ...
            var y, M, x = this, _ = ta.select(ta.event.target), w = a.of(x, arguments), S = ta.select(x), k = _.datum(),
                E = !/^(n|s)$/.test(k) && c, A = !/^(e|w)$/.test(k) && l, N = _.classed("extent"), C = $(),
    ...
    var Il = {
            ...
            se: "nwse-resize",
            sw: "nesw-resize"
        }, Zl = [["n", "e", "s", "w", "nw", "ne", "se", "sw"], ["e", "w"], ["n", "s"], []], Vl = fc.format = mc.timeFormat,
        Xl = Vl.utc, $l = Xl("%Y-%m-%dT%H:%M:%S.%LZ");
